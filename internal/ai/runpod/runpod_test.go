...
func TestStream_MissingKey(t *testing.T) {
	...
	if err == nil || !strings.Contains(err.Error(), "runpod API key") {
		t.Fatalf("err = %v", err)
	}
}
...
func TestNormalizeEndpoint(t *testing.T) {
	cases := map[string]string{
		"gpt-oss-120b": "https://api.runpod.ai/v2/gpt-oss-120b/openai/v1/chat/completions",
		"https://api.runpod.ai/v2/custom/openai/v1":                  "https://api.runpod.ai/v2/custom/openai/v1/chat/completions",
		"https://api.runpod.ai/v2/custom/openai/v1/chat/completions": "https://api.runpod.ai/v2/custom/openai/v1/chat/completions",
	}
